      ...
      >
        <Card className="w-full max-w-md bg-white/95 backdrop-blur-sm shadow-2xl">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-gray-800">Create Your Profile</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            <div>
              ...
              <Input
                ...
                className="mt-2 text-lg p-3 border-2 border-gray-200 focus:border-purple-400"
                maxLength={15}
              />
            </div>

            <div>
              <Label className="text-lg font-medium mb-4 block">Pick Your Avatar</Label>
                ...
                {avatars.map((avatar, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`p-3 rounded-full ${avatar.color} ${
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                ...
                className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white py-3 text-lg rounded-lg disabled:opacity-50"
              >
                Start Playing XO
              </Button>
            </motion.div>
